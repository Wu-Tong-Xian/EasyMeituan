    ...
    <div class="head-box">
      ...
      { type: 'email', message: '请输入正确的邮箱地址', trigger: ['blur', 'change'] }
            ...
            <el-form-item>
              ...
              <div class="fl">
              <el-button class="confirm " type="primary" @click="goXieyi('ruleForm')">《美团点评用户服务协议》 </el-button>
              <el-button class="confirm " type="primary" @click="goXieyi('ruleForm')">《美团点评隐私政策》 </el-button>
              </div>
  ...
  methods: {
    ...
    yzm (){
      const h = this.$createElement;
        this.$notify({
          title: '验证码提示',
          message: h('i', { style: 'color: red'}, '想太多了,老大没给这个验证码接口,最为小弟我也没办法,直接下一步吧')
        });
    },
    submitForm(formName) {
