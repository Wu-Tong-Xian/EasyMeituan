      ...
      <div class="w960 fl j-between fz12 colg c-pointer">
        ...
        <div class="fl j-between left-head1">
          ...
          <el-dropdown size="mini">
            <span class="el-dropdown-link h-hover"  >我的美团<i class="el-icon-arrow-down el-icon--right"></i></span>
          ...
          <div @click="gophoneApp" class="h-hover">手机APP</div>
           <!-- 下拉菜单 -->
          <el-dropdown size="mini">
            <span class="el-dropdown-link h-hover"  >商家中心<i class="el-icon-arrow-down el-icon--right"></i></span>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item>我的订单</el-dropdown-item>
              <el-dropdown-item>我的收藏</el-dropdown-item>
              <el-dropdown-item>抵用卷</el-dropdown-item>
