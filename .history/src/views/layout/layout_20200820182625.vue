  ...
  <div>
    ...
    <div class="search-box">
      <div class="w9601">
        ...
        <div class="input-box j-between">
          <el-input @input="search1" placeholder="请输入内容" v-model="keyword"  class="input-with-select">
...
export default {
  ...
  methods: {
    // 搜索建议
    search1(){
      console.log(this.city,this.keyword);
      this.$api.getsearchTop(this.city,this.keyword).then(res =>{
        console.log(res);
      }).catch(err =>{
        console.log(err);
      })
