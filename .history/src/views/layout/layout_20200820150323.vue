    ...
    <div class="head1">
      <div class="w960 fl j-between fz12 colg c-pointer">
        ...
        <div class="fl left-head1 j-between">
          ...
          <div @click="citySelection" class="h-hover">切换城市</div>
        ...
        <!--头部又边-->
        <div class="fl j-between left-head1">
          <!-- 下拉菜单 -->
          <el-dropdown size="mini">
            <span class="el-dropdown-link h-hover colg fz12"  >我的美团<i class="el-icon-arrow-down el-icon--right"></i></span>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item class="colg">我的订单</el-dropdown-item>
              <el-dropdown-item class="colg">我的收藏</el-dropdown-item>
          ...
          <div @click="gophoneApp" class="h-hover">手机APP</div>
           <!-- 下拉菜单 -->
          <el-dropdown size="mini">
            <span class="el-dropdown-link h-hover colg fz12"  >商家中心<i class="el-icon-arrow-down el-icon--right"></i></span>
            <el-dropdown-menu slot="dropdown">
           ...
           <!-- 下拉菜单 -->
          <el-dropdown size="mini">
            <span class="el-dropdown-link h-hover colg fz12"  >美团规则<i class="el-icon-arrow-down el-icon--right"></i></span>
            <el-dropdown-menu slot="dropdown">
