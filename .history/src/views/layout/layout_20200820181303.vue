    ...
    <div class="search-box">
      <div class="w9601">
        ...
        <div class="input-box j-between">
          <el-input @input="search1" placeholder="请输入内容" v-model="input3"  class="input-with-select">
...
export default {
  ...
  methods: {
    // 搜索建议
    search1(){
      console.log(this.city,this.input3);
      this.$api.getsearchTop(this.city,this.input3).then(res =>{
        console.log(res);
      }).catch(err =>{
        console.log(err);
      })
