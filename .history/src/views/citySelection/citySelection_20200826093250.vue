...
<div>
  <div class="w960">
    <div class="mg-lr10">
      ...
      <div class="fl mg-t20 fl-wrap   fz14 j-between" v-for="(item,index1) in city1" :key="index1">
        <!-- 左侧得字母 跟右侧城市对应得城市名-->
        <div class="index-box t-center mg-t10">{{index1}}</div>

        <div :id="index1" class="fl citys-box fl-wrap ">
